...
/* PARAMETERS */
String channel = "GFP" // "HTX", "DAB", "Residual" for BF ; use channel name for FL ; "Average":Mean of all channels for BF/FL
double thresholdDownsample = 2 // 1:Full, 2:Very high, 4:High, 8:Moderate, 16:Low, 32:Very low, 64:Extremely low
...
String output = "detection" // "annotation", "detection", "measurement", "preview", "threshold value"
// Reset preview overlay with "getQuPath().getViewer().resetCustomPixelLayerOverlay()"

double classifierDownsample = 1 // 1:Full, 2:Very high, 4:High, 8:Moderate, 16:Low, 32:Very low, 64:Extremely low
double classifierGaussianSigma = 1 // Strength of gaussian blurring for pixel classifier (not used in calculation of threshold)
String classBelow = null // null or "Class Name"; use this for positive "Average" channel on brightfield
String classAbove = "your class name here" // null or "Class Name"; use this for positive deconvoluted or fluorescence channels

/* Create object parameters, ignore if you are not creating objects with this script */
...
//modify this portion of the script to have the autothreshold run in the objects you car about (cells, detections, annotations)
selectAnnotations()
