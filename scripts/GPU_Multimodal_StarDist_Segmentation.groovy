...
param_expansion=2 //size of cell expansion in pixels. Default is 10.
...
def min_nuc_intensity=400 //remove any detections with an intensity less than or equal to this value
nuc_intensity_measurement='DAPI: Nucleus: Mean'
